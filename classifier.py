...
def infer(args, multiple=False):
    ...
    for img in args.imgs:
        ...
        for r in reps:
            ...
            with open(args.resultDump, 'a') as o:
                o.write("{}\t{}\t{}\t{}\n".format(img, args.classifierModel, person.decode('utf-8'), confidence))
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--resultDump',
        type=str,
        help='the output file for the confidence results',
        default='ans.txt'
    )
    parser.add_argument(
        '--dlibFacePredictor',
